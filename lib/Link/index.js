  ...
  _createClass(Link, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties(_props, ['decoratedText', 'theme', 'target', 'className', 'component', 'dir', 'entityKey', 'getEditorState', 'offsetKey', 'setEditorState', 'contentState', 'blockKey']);
